<main>
	...
	<form id="goods-add-input" action="" method="get"></form>

	<form id="goods-add-image" action="" method="post" enctype="multipart/form-data"></form>
								...
								<tbody><tr valign="top">
									<td>
										...
										<div id="step-holder">
											...
											<div class="step-dark-left"><a href="">Add new book</a></div>
												...
												<td>
													<label>
														<select class="inp-form-select" form="goods-add-input" type="text" name="availability">
															<option>Книга в наличии</option>
															<option>Книги в наличии нет</option>
														</select>
													</label>
												</td>
												<td></td>
